...
from Utils.GenerateTimelapse import generateTimelapseFromFrameBlocks, listImageBlocksBefore, findLastNightFrameInWindow
...
def processNight(night_data_dir, config, detection_results=None, nodetect=False):
    ...
    # The timelapse is made in archiveDetections, in the same pass over the FF files as the captured
    # thumbnails and stack
