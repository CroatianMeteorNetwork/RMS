...
def _topic_astrometry(gui):
    ...
    body = (
        ...
        "are kept in full). This typically improves the corners substantially when the "
        "calibration frame had few corner stars. Photometry is untouched &ndash; it must come "
        "from a single frame.</p>"
