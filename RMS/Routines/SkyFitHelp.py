...
def _topic_astrometry(gui):
    ...
    body = (
        ...
        "<p><b>Refit Multi-Frame</b> (in the Fit section) feeds those pairs back into the "
        "astrometric fit &ndash; it runs the validation itself first if there is no current one, "
        "so it can be pressed on its own. "
...
def _topic_stardetect(gui):
    ...
    body = (
        ...
        "Without it, the night-wide steps (Validate Multi-Frame, Refit Multi-Frame, Find Best "
