 ...
 * 
 */
  __pyx_tuple__6 = PyTuple_Pack(8, __pyx_n_s_img, __pyx_n_s_bin_factor, __pyx_n_s_method, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_img_h, __pyx_n_s_img_w, __pyx_n_s_out_img); if (unlikely(!__pyx_tuple__6)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__6);
  __Pyx_GIVEREF(__pyx_tuple__6);
  __pyx_codeobj__7 = (PyObject*)__Pyx_PyCode_New(3, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__6, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_RMS_Routines_BinImageCy_pyx, __pyx_n_s_binImage, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__7)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
