...
class StarDetectionWidget(QtWidgets.QWidget):
    ...
    def __init__(self, gui):
        ...
        self.intensity_threshold_slider.setValue(18)  # Default
        ...
        self.intensity_threshold_label = QtWidgets.QLabel('Threshold: 18')
        self.intensity_threshold_label.setMinimumWidth(100)
        self.intensity_threshold_label.setAlignment(QtCore.Qt.AlignRight)
        ...
        form.addRow(QtWidgets.QLabel('Intensity Threshold:'), threshold_layout)

        # Neighborhood Size
        neighborhood_layout = QtWidgets.QVBoxLayout()
        ...
        self.neighborhood_size_slider.setValue(10)  # Default
        ...
        self.neighborhood_size_label = QtWidgets.QLabel('Neighborhood: 10')
        self.neighborhood_size_label.setMinimumWidth(130)
        self.neighborhood_size_label.setAlignment(QtCore.Qt.AlignRight)
        neighborhood_slider_layout.addWidget(self.neighborhood_size_label)

        neighborhood_layout.addLayout(neighborhood_slider_layout)
        neighborhood_help = QtWidgets.QLabel('Smaller = more detections')
        neighborhood_help.setStyleSheet("color: gray; font-size: 8pt;")
        neighborhood_layout.addWidget(neighborhood_help)
        form.addRow(QtWidgets.QLabel('Neighborhood Size:'), neighborhood_layout)

        # Max Stars
        maxstars_layout = QtWidgets.QVBoxLayout()
        ...
        self.max_stars_slider.setValue(200)  # Default
        self.max_stars_slider.setSingleStep(50)
        self.max_stars_slider.setPageStep(100)
        self.max_stars_slider.valueChanged.connect(self.onMaxStarsChanged)
        maxstars_slider_layout.addWidget(self.max_stars_slider)

        self.max_stars_label = QtWidgets.QLabel('Max Stars: 200')
        self.max_stars_label.setMinimumWidth(110)
        self.max_stars_label.setAlignment(QtCore.Qt.AlignRight)
        maxstars_slider_layout.addWidget(self.max_stars_label)

        maxstars_layout.addLayout(maxstars_slider_layout)
        maxstars_help = QtWidgets.QLabel('Maximum candidates to process')
        maxstars_help.setStyleSheet("color: gray; font-size: 8pt;")
        maxstars_layout.addWidget(maxstars_help)
        form.addRow(QtWidgets.QLabel('Max Stars:'), maxstars_layout)
        ...
        self.gamma_slider.setMinimum(45)   # 0.45 (1/2.2)
        self.gamma_slider.setMaximum(200)  # 2.0
        ...
        self.gamma_label = QtWidgets.QLabel('Gamma: 1.000')
        self.gamma_label.setMinimumWidth(110)
        self.gamma_label.setAlignment(QtCore.Qt.AlignRight)
        gamma_slider_layout.addWidget(self.gamma_label)

        gamma_layout.addLayout(gamma_slider_layout)

        # Add preset buttons for common gamma values
        preset_layout = QtWidgets.QHBoxLayout()
        preset_label = QtWidgets.QLabel('Presets:')
        preset_label.setStyleSheet("color: gray; font-size: 8pt;")
        preset_layout.addWidget(preset_label)

        gamma_preset_122 = QtWidgets.QPushButton('1/2.2')
        gamma_preset_122.setMaximumWidth(50)
        gamma_preset_122.clicked.connect(lambda: self.gamma_slider.setValue(45))  # 0.455
        preset_layout.addWidget(gamma_preset_122)

        gamma_preset_118 = QtWidgets.QPushButton('1/1.8')
        gamma_preset_118.setMaximumWidth(50)
        gamma_preset_118.clicked.connect(lambda: self.gamma_slider.setValue(56))  # 0.556
        ...
        gamma_layout.addLayout(preset_layout)

        gamma_help = QtWidgets.QLabel('Affects star intensity measurement during detection')
        gamma_help.setStyleSheet("color: gray; font-size: 8pt;")
        gamma_layout.addWidget(gamma_help)
        form.addRow(QtWidgets.QLabel('Gamma:'), gamma_layout)

        # Segment Radius
        segment_layout = QtWidgets.QVBoxLayout()
        ...
        self.segment_radius_slider.setValue(4)  # Default
        ...
        self.segment_radius_label = QtWidgets.QLabel('Segment Radius: 4')
        self.segment_radius_label.setMinimumWidth(130)
        self.segment_radius_label.setAlignment(QtCore.Qt.AlignRight)
        segment_slider_layout.addWidget(self.segment_radius_label)

        segment_layout.addLayout(segment_slider_layout)
        segment_help = QtWidgets.QLabel('Larger = better for bright stars')
        segment_help.setStyleSheet("color: gray; font-size: 8pt;")
        segment_layout.addWidget(segment_help)
        form.addRow(QtWidgets.QLabel('Segment Radius:'), segment_layout)
        ...
        self.max_feature_ratio_slider.setMinimum(50)   # 0.5
        self.max_feature_ratio_slider.setMaximum(200)  # 2.0
        self.max_feature_ratio_slider.setValue(80)     # Default 0.8
        self.max_feature_ratio_slider.setSingleStep(5)
        ...
        self.max_feature_ratio_label = QtWidgets.QLabel('Max Feature: 0.80')
        self.max_feature_ratio_label.setMinimumWidth(130)
        self.max_feature_ratio_label.setAlignment(QtCore.Qt.AlignRight)
        feature_slider_layout.addWidget(self.max_feature_ratio_label)

        feature_layout.addLayout(feature_slider_layout)
        feature_help = QtWidgets.QLabel('Higher = allow larger stars')
        feature_help.setStyleSheet("color: gray; font-size: 8pt;")
        feature_layout.addWidget(feature_help)
        form.addRow(QtWidgets.QLabel('Max Feature Ratio:'), feature_layout)

        # Roundness Threshold
        roundness_layout = QtWidgets.QVBoxLayout()
        roundness_slider_layout = QtWidgets.QHBoxLayout()

        self.roundness_threshold_slider = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.roundness_threshold_slider.setMinimum(30)  # 0.3
        self.roundness_threshold_slider.setMaximum(90)  # 0.9
        self.roundness_threshold_slider.setValue(50)    # Default 0.5
        self.roundness_threshold_slider.setSingleStep(5)
        ...
        self.roundness_threshold_label = QtWidgets.QLabel('Roundness: 0.50')
        self.roundness_threshold_label.setMinimumWidth(130)
        self.roundness_threshold_label.setAlignment(QtCore.Qt.AlignRight)
        roundness_slider_layout.addWidget(self.roundness_threshold_label)

        roundness_layout.addLayout(roundness_slider_layout)
        roundness_help = QtWidgets.QLabel('Filters hot pixels (narrow features)')
        roundness_help.setStyleSheet("color: gray; font-size: 8pt;")
        roundness_layout.addWidget(roundness_help)
        form.addRow(QtWidgets.QLabel('Roundness Threshold:'), roundness_layout)

        layout.addSpacing(10)

        # Re-detect button
        self.redetect_button = QtWidgets.QPushButton('Re-Detect Stars on Current Image')
        ...
        self.redetect_all_button = QtWidgets.QPushButton('Re-Detect All Images in Series')
        ...
        self.redetect_all_button.setToolTip(
            'Re-detect stars on all FF files in the directory with current override parameters.\n'
            'This enables picking stars from all images with consistent gamma.'
        )
