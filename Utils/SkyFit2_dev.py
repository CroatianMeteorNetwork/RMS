...
class PlateTool(QtWidgets.QMainWindow):
    ...
    def setupUI(self, loaded_file=False):
        ...
        # Outer rings (dark green) - main window
        self.calstar_markers_outer = pg.ScatterPlotItem()
        self.calstar_markers_outer.setPen(pg.mkPen((0, 100, 0, 255), width=1.5))  # Dark green, thick line
        ...
        # Inner rings (bright green) - main window
        self.calstar_markers = pg.ScatterPlotItem() 
        self.calstar_markers.setPen(pg.mkPen((50, 255, 50, 255), width=1.5))  # Bright green
        self.calstar_markers.setBrush((0, 0, 0, 0))
        self.calstar_markers.setSize(10)
        self.calstar_markers.setSymbol('o')
        self.calstar_markers.setZValue(3)
        self.img_frame.addItem(self.calstar_markers)

        # Outer rings (dark green) - zoom window
        self.calstar_markers_outer2 = pg.ScatterPlotItem()
        self.calstar_markers_outer2.setPen(pg.mkPen((0, 100, 0, 255), width=1.5))  # Dark green, thick line
        ...
        # Inner rings (bright green) - zoom window
        self.calstar_markers2 = pg.ScatterPlotItem()
        self.calstar_markers2.setPen(pg.mkPen((50, 255, 50, 255), width=1.5))  # Bright green
        self.calstar_markers2.setBrush((0, 0, 0, 0))
        self.calstar_markers2.setSize(20)
        self.calstar_markers2.setSymbol('o')
        self.calstar_markers2.setZValue(6)
